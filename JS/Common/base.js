class Base {
    ...
    LoadData(isStudentGood) {
        ...
        this.listStudent.forEach(function (item, index) {
            ...
            buttonEdit.setAttribute("class", "btnEdit btn");
            buttonEdit.setAttribute("recordid", item["Id"]);
            let buttonDelete = document.createElement("button");
            buttonDelete.innerHTML = "Delete";
            buttonDelete.setAttribute("recordid", item["Id"]);
            buttonDelete.setAttribute("class", "btnDelete btn");
